...
=======
    <div class="flex-body">
        <div class="article-contain gradient-border">
>>>>>>> 7cbe526245f00775675953f572b7ac1da75409ff
...
=======
                    <p> J'ai commencé par me former seule à la maison aux langages HTML, CSS et JS via Openclassrooms pour des débuts purement front-end. <br><br> Depuis le 25 octobre 2021, j'ai eu la chance d'intégrer une formation d'Alaji pour devenir développeur web full stack.<br>
                        <br> Nous avons ainsi entamé le programme sur plusieurs thèmes :
                    </p>
                    ...
                    <ul style="list-style-image:square;">
                        ...
                        <li> pour l'aspect visuel, les langages CSS, SCSS, ainsi que les outils Bootstrap et Figma, </li>
                        <li> une approche également de Javascript et de la bibliothèque JQuerry pour modifier le DOM, et la découverte de la méthode Ajax, bientôt Typescript,</li>
